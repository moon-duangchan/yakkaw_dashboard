...
type SensorData struct {
    ...
    DVID         string `gorm:"column:dvid;size:10;index:idx_dvid_timestamp,unique" json:"dvid"`
    ...
    Timestamp    int64   `gorm:"column:timestamp;index:idx_dvid_timestamp,unique" json:"timestamp"`
