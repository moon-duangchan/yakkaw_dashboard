  ...
  const NavLinksMobile = () => (
    <>
      <Link
        ...
        className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors"
      >
        <div className="flex items-center px-5 py-3 my-1 hover:bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg transition-all">
          <Home className="h-4 w-4 mr-2 text-indigo-600" />
          <span className="text-indigo-800">Dashboard</span>
        </div>
      </Link>
      <Link
        href="/notifications"
      ...
      >
        <div className="flex items-center px-5 py-3 my-1 hover:bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg transition-all">
          ...
          <span className="text-purple-800">Notifications</span>
        </div>
      </Link>
      <Link
        href="/sponsor"
      ...
      >
        <div className="flex items-center px-5 py-3 my-1 hover:bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg transition-all">
          ...
          <span className="text-pink-800">Sponsor</span>
        </div>
      </Link>
    </>
  );
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur-lg supports-[backdrop-filter]:bg-background/70 shadow-xl">
